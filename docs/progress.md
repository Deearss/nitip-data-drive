...
## What's Done
- ✅ Project initialized via Next.js (Tailwind v4, App Router, TypeScript).
- ✅ Installed strict stack dependencies: `zustand`, `lucide-react`, `motion`, `clsx`.
- ✅ Setup Shadcn UI components (button, dialog, input, label, dropdown-menu, scroll-area, tooltip).
